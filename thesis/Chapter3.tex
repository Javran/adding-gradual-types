...
Programs with type inference and gradual typed programs have some similarity in the sense
that it allows programmers to write less type annotation themselves.
