...
can be combined together to construct one single object, and these values
can be retrieved later using a key or index into that object.
This allows programmers to organize related data together for further processing.
