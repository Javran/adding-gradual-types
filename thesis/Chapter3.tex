...
With Typed Scheme the concept of occurrence typing is introduced.
Instead of using classes or objects like other languages do,
it prefers using composed data structures as simple as just pairs, vectors
and they are distinguished through testing the shape of the value.
