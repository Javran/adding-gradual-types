...
In this chapter, we will explore some research works and focus on the syntactic aspects of them
to show improvements to programming experience with the introduction of gradual typing.
...
\subsection{Structural and Nominal Types}
