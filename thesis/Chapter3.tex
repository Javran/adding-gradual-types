...
\subsubsection{Type for Objects}
...
\subsection{Nominal Type, Structural Type and Subtyping}
...
\subsection{Objects and Dynamic Semantics}
...
\subsubsection{The Guarded Dynamic Semantics}
...
\subsubsection{The Transient Dynamic Semantics}
...
\subsubsection{The Monotonic Dynamic Semantics}
...
Safe TypeScript features a calculus that decreases RTTI overtime - 
reducing runtime checks when checks could have been performed once for all.
