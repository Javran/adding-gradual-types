...
and a compiler typechecks TypeScript source code ahead of execution
and compile it into plain JavaScript source code, making it ready to be executed out of box
