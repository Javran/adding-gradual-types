...
Python 3 is another popular dynamic typed language.
M. Vitousek, M. Kent and Baker's work on Reticulated Python
explored extending Python 3 with gradual typing.

Python 3 comes with annotation syntax.
