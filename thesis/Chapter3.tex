...
\subsection{Extra Runtime for Dynamic Languages}

For dynamically typed languages to have typechecking abilities at runtime,
several languages implements external libraries.
