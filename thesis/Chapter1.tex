...
extra maintenance efforts are required to keep type annotation up-to-date,
which might not be desired in many situations.
...
to keep and check runtime type information.
