...
(Alternative opening) Despite that gradual type systems are well-studied topic
in theoretical world, extending existing languages to support it
is far from trivial task: practical languages deal with
various kinds of primitive data type, structured data,
and successful extension requires understanding of 
...
This chapter shows us the syntactic aspect of research works:
namely how these extensions make improvements to programming experiences.
