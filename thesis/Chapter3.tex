...
fields are of consistent types. To allow type expressiveness to extend further,
the concept of self instance and self class is also introduced.

\subsubsection{Differential Subtyping}
