...
Gradual typing brings existing languages not just the benefits of both static and dynamic typing.
The synergy also introduces surprising new benefits to languages users.
